...
public interface ZigTypes {
  ...
  IElementType FOR_OPERAND = new ZigElementType("FOR_OPERAND");
  IElementType FOR_PREFIX = new ZigElementType("FOR_PREFIX");
  IElementType FOR_RANGE = new ZigElementType("FOR_RANGE");
  ...
  IElementType VAR_DECL = new ZigElementType("VAR_DECL");
  ...
  IElementType KEYWORD_NOILINE = new ZigTokenType("KEYWORD_NOILINE");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == FOR_OPERAND) {
        return new ZigForOperandImpl(node);
      }
      else if (type == FOR_PREFIX) {
        return new ZigForPrefixImpl(node);
      }
      else if (type == FOR_RANGE) {
        return new ZigForRangeImpl(node);
      }
