...
public class ZigForRangeImpl extends ASTWrapperPsiElement implements ZigForRange {

  public ZigForRangeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getDot2() {
    return findNotNullChildByType(DOT2);
  }
