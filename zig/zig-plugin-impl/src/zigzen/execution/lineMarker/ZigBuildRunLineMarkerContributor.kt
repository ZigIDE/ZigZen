...
class ZigBuildRunLineMarkerContributor : AbstractZigRunLineMarkerContributor() {
  override fun getDeclaration(element: PsiElement): PsiElement? {
    ...
    if ((element.containingFile?.virtualFile?.name ?: return null) != "build.zig")
      return null
  ...
  companion object {
    val instance = ZigBuildRunLineMarkerContributor()
  }
}
